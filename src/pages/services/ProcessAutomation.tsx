                    ...
                    <div className="container mx-auto px-4 md:px-6">
                        <div className="max-w-4xl mx-auto text-center space-y-6">
                            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 mb-4">
                                ...
                                <span className="text-sm text-white/80">Process Automation Services</span>
                            </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {useCases.map((useCase, index) => (
                                <TiltCard key={index} className="bw-card p-8 hover:bg-white/5 transition-all duration-500">
                                    ...
                                    <p className="text-white/60 leading-relaxed text-sm mb-4">{useCase.example}</p>
                                    <div className="pt-4 border-t border-white/10">
                                        <span className="text-xs font-semibold text-white/80">{useCase.metrics}</span>
                                    </div>
                                </TiltCard>
                            ))}
                        </div>
