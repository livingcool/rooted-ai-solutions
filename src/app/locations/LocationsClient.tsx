    ...
    <div style={{ background: "#240747" }}>
      ...
      <div style={{ background: "#240747", padding: "4px 4px 0" }}>
        <div style={{ maxWidth: 1320, margin: "0 auto", background: "#F9EFE9", padding: "3.5rem 3.5rem 3rem" }}>
          <span className="nb-label-orange animate-fade-in" style={{ display: "block", marginBottom: "1rem" }}>Where We Operate</span>
      ...
      <div style={{ background: "#240747", padding: "4px" }}>
        <div style={{ maxWidth: 1320, margin: "0 auto" }} className="grid grid-cols-1 sm:grid-cols-2 gap-[4px]">
          {LOCATIONS.map((loc) => (
            <Link
              key={loc.href}
              href={loc.href}
