...
export default function InterviewPage() {
    ...
    const applicationId = typeof window !== 'undefined' ? sessionStorage.getItem('candidateId') : null;
                ...
                <Card className="bg-white/5 border-white/10 backdrop-blur-sm">
                    <CardContent className="p-8 text-center space-y-8">
                        ...
                        <div className="flex justify-center gap-4">
                            {!recording && !audioUrl && (
                                <Button size="lg" className="bg-white text-black hover:bg-white/90 rounded-full px-8" onClick={startRecording}>
                                    <Mic className="w-4 h-4 mr-2" /> Start Recording
                                </Button>
                            )}

                            {recording && (
                                <Button size="lg" variant="destructive" className="rounded-full px-8" onClick={stopRecording}>
                            ...
                            {audioUrl && (
                                <div className="flex gap-4">
                                    <Button variant="outline" className="border-white/20 hover:bg-white/10 text-white rounded-full" onClick={() => { setAudioUrl(null); setAudioBlob(null); }}>
                                        Retake
                                    </Button>
                                    <Button className="bg-white text-black hover:bg-white/90 rounded-full px-8" onClick={handleNext} disabled={submitting}>
