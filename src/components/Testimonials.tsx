  ...
  return (
    ...
    >
      ...
      <motion.div 
        variants={fadeUp} 
        whileHover={{ y: -5 }} 
        style={{ ...tileObj(C.cream), gridColumn: "span 4", padding: "2.5rem", display: "flex", flexDirection: "column", gap: "1.5rem", position: "relative" }}
      ...
      <motion.div 
        variants={fadeUp} 
        whileHover={{ y: -5 }} 
        style={{ ...tileObj(C.blush), gridColumn: "span 4", padding: "2.5rem", display: "flex", flexDirection: "column", gap: "1.5rem" }}
        className="col-span-full md:col-span-4"
      >
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
            <div style={{ background: C.purple, padding: "0.75rem", borderRadius: 12 }}>
      ...
      <motion.div 
        variants={fadeUp} 
        whileHover={{ y: -5 }} 
        style={{ ...tileObj(C.amber), gridColumn: "span 4", padding: "2.5rem", display: "flex", flexDirection: "column", gap: "1.5rem" }}
        className="col-span-full md:col-span-4"
      >
