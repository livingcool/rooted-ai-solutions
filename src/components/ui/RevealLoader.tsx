...
const RevealLoader = ({
    ...
    return (
        <div
            className={cn(
                "fixed inset-0 z-[9999] flex overflow-hidden bg-transparent", // Increased z-index to cover everything
                className,
            )}
            ref={preloaderRef}
        >
            ...
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                <div className="overflow-hidden">
                    <p
                        className={cn(
                            "name-text flex leading-none tracking-tighter font-heading", // Used font-heading class
                        )}
                        style={{
                            fontSize: "clamp(3rem, 10vw, 100px)", // Responsive font size
                            color: textColor,
                            fontWeight: "400",
