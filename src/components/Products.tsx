                ...
                <div className="max-w-7xl mx-auto">
                    {products.map((product, index) => (
                        <div key={index} className="space-y-8">
                            {/* Main Product Card */}
                            <TiltCard className="bw-card p-8 md:p-12 group hover:bg-white/5 transition-all duration-500">
                                <div className="grid lg:grid-cols-2 gap-12 items-center">
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div className="flex items-center gap-6">
                                            <div className="relative">
                                                <div className="absolute inset-0 bg-gradient-to-br from-white/20 to-white/5 rounded-2xl blur-xl transition-all duration-500" />
                                                <img
                                                    src={product.logoUrl}
                                            ...
                                            <div className="flex items-center gap-2 bg-white/5 border border-white/10 px-4 py-2 rounded-full">
                                                ...
                                                <span className="text-xs text-white/80 font-medium">{product.status}</span>
                                            </div>
                                        </div>

                                        {/* Title & Tagline */}
                                        <div className="space-y-3">
                                            <h3 className="text-3xl md:text-5xl font-bold text-white group-hover:translate-x-1 transition-transform duration-300">
                                                {product.name}
                                            </h3>
                                        ...
                                        <div className="space-y-2">
                                            <div className="text-sm font-semibold text-white/90">Use Cases:</div>
                                            <div className="space-y-2">
                                        ...
                                        <div className="grid grid-cols-1 gap-3">
                                            {product.features.map((feature, idx) => (
                                                <div
                                                    key={idx}
                                                    className="flex items-center gap-3 bg-white/5 border border-white/10 rounded-lg px-4 py-3 group-hover:bg-white/10 transition-colors duration-300"
                                                >
                                                    <feature.icon className="w-5 h-5 text-white/60 flex-shrink-0" />
                                        ...
                                        <div className="flex flex-col sm:flex-row gap-4 pt-4">
                                            <a
                                                ...
                                                className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-white text-black font-semibold rounded-lg hover:bg-white/90 transition-all duration-300 group/btn"
                                            >
                                                Launch Product
                                    ...
                                    <div className="relative">
                                        <div
                                            className="relative aspect-[4/3] rounded-2xl overflow-hidden border border-white/10 bg-gradient-to-br from-white/5 to-transparent perspective-1000"
                                        ...
                                        >
                                            ...
                                            <div className="absolute inset-0 flex items-center justify-between p-4 opacity-0 hover:opacity-100 transition-opacity duration-300 bg-gradient-to-r from-black/20 via-transparent to-black/20">
                                                <Button
                                                    ...
                                                    size="icon"
                                                    onClick={prevImage}
                                                    className="bg-white/10 backdrop-blur-sm hover:bg-white hover:text-black border border-white/20 rounded-full"
                                                >
                ...
                <div className="mt-16 text-center">
                    <div className="bw-card p-8 md:p-12 max-w-3xl mx-auto bg-gradient-to-b from-white/5 to-transparent">
                        ...
                        <button
                            ...
                            className="px-8 py-3 bg-white text-black font-semibold rounded-lg hover:bg-white/90 transition-all duration-300"
                        >
                            Get in Touch
                        </button>
                    </div>
